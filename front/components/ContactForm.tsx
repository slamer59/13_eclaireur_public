...
export default function ContactForm() {
  ...
  return (
    ...
    >
      <div>
        <label htmlFor="usermail" className="block">Email</label>
        <input
          type="email"
          id="usermail"
          name="usermail"
          ...
          className="block shadow-md px-6 py-2 border border-slate-300 w-full"
        />
      </div>
      <div>
      ...
      <div>
        <button className="block shadow-md px-6 py-2 border border-slate-300">
          Envoyer
        </button>
      </div>
