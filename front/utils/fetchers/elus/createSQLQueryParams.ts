...
export type ElusOptions = {
  selectors?: (keyof Elu)[];
  filters?: Partial<Pick<Elu, 'siren' | 'type'>>;
  limit?: number;
};

const TABLE_NAME = DataTable.Elus;
 ...
 * @returns
 */
export function createSQLQueryParams(options?: ElusOptions, pagination?: Pagination) {
